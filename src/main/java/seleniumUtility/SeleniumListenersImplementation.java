...
public class SeleniumListenersImplementation implements ITestListener{
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			String path = wUtil.captureScreenShot(SeleniumBaseClass.sdriver, methodName);
	...
	public void onStart(ITestContext context) {
		repoter = new ExtentSparkReporter(".\\ExtentReport\\ExtentReport Web"+new JavaUtility().getCurrentDateAndTime()+".html");
