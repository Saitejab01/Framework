...
public class RestAssuredListenersImplementation implements ITestListener{
	...
	public void onStart(ITestContext context) {
		ExtentSparkReporter repoter = new ExtentSparkReporter(".\\ExtentReport\\ExtentReport API"+new JavaUtility().getCurrentDateAndTime()+".html");
